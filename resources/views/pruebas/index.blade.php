        ...
        <div class="contenido">
            ...
            <div class="formulario-prueba mb-3">
                ...
                <p class="text-start mt-5 mb-5">
                    Frente a usted hay tres muestras de (<span class="nombre-producto-span">nombre del producto</span>) 
                    dos son iguales y una diferente, saboree cada una con cuidado y seleccione la muestra diferente.
                </p>
    ...
    <section class="text-center" id="sect2">
        <div class="contenido">
            ...
            <div class="formulario-prueba mb-3">
                ...
                <p class="text-start mt-5 mb-5">
                    ¿Cual de las muestras codificadas es diferente a la de referencia R? Seleccione la muestra diferente.
                </p>
    ...
    <section class="text-center" id="sect3">
        <div class="contenido">
            ...
            <div class="formulario-prueba mb-3">
                ...
                <p class="text-start mt-5 mb-5">
                    Frente a usted hay tres muestras de (<span class="nombre-producto-span">nombre del producto</span>) 
                    que usted debe ordenar en forma creciente de acuerdo al grado de <span class="atributo-span">dulzura</span>.
                </p>
                <p class="text-start mt-5 mb-5">
                ...
                <table class="table table-bordered table-hover table-secondary mb-3">
                    ...
                    <tbody id="cuerpo-selectores-ordenamiento"></tbody>
                </table>
